...
# Озвучені раніше проблеми вирішив, на defи все розподілив, додав можливость переграти, обробку помилок типу реалізував. 
# ПО ТЗ, наче справився.

# Про додати/змінити/прибрати не знаю, але з очевидного щоб виводилось воно табличкою де літери мали б 
# фон зеленого та жовтого кольору замість [] та (), можливо якусь статистику, щоб щось зберігалось.
